    ...
    <section id="services" class="section" style="background-color: #000000;">
        <div class="container">
            ...
            <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s"
                ...
                través de Mate, se te concede una licencia limitada, no exclusiva e intransferible para utilizar el
                software
                ...
                <br>
                3. Precios y pagos
                El precio de las licencias de software se indica en la página web de Mate. Los precios pueden estar
                sujetos
